...
/** 
 * Allows a running application to be restarted with an updated classpath. The restarter works by creating a new application ClassLoader that is split into two parts. The top part contains static URLs that don't change (for example 3rd party libraries and Spring Boot itself) and the bottom part contains URLs where classes and resources might be updated. <p> The Restarter should be  {@link #initialize(String[]) initialized} early to ensure thatclasses are loaded multiple times. Mostly the  {@link RestartApplicationListener} can berelied upon to perform initialization, however, you may need to call {@link #initialize(String[])} directly if your SpringApplication arguments are notidentical to your main method arguments. <p> By default, applications running in an IDE (i.e. those not packaged as "fat jars") will automatically detect URLs that can change. It's also possible to manually configure URLs or class file updates for remote restart scenarios.
 * @author Phillip Webb
...
public class Restarter {
  public static Object INSTANCE_MONITOR=new Object();
  public static String[] NO_ARGS={};
  public static Restarter instance;
  public Set<URL> urls=new LinkedHashSet<URL>();
  public ClassLoaderFiles classLoaderFiles=new ClassLoaderFiles();
  public Map<String,Object> attributes=new HashMap<String,Object>();
  public BlockingDeque<LeakSafeThread> leakSafeThreads=new LinkedBlockingDeque<LeakSafeThread>();
  public Lock stopLock=new ReentrantLock();
  public Object monitor=new Object();
  public Log logger=new DeferredLog();
  public boolean forceReferenceCleanup;
  public boolean enabled=true;
  public URL[] initialUrls;
  public String mainClassName;
  public ClassLoader applicationClassLoader;
  public String[] args;
  public UncaughtExceptionHandler exceptionHandler;
  public boolean finished=false;
  public List<ConfigurableApplicationContext> rootContexts=new CopyOnWriteArrayList<ConfigurableApplicationContext>();
  /** 
 ...
 * @see #initialize(String[])
 */
  public Restarter(  Thread thread,  String[] args,  boolean forceReferenceCleanup,  RestartInitializer initializer){
  ...
  public String getMainClassName(  Thread thread){
    try {
  ...
  public void initialize(  boolean restartOnInitialize){
 ...
 */
  public void preInitializeLeakyClasses(){
    try {
 ...
 */
  public void start(  FailureHandler failureHandler) throws Exception {
    do {
 ...
 while (true);
  ...
  public Throwable doStart() throws Exception {
 ...
 * @throws Exception in case of errors
 */
  public Throwable relaunch(  ClassLoader classLoader) throws Exception {
 ...
 */
  ...
  public void cleanupCaches() throws Exception {
    Introspector.flushCaches();
    cleanupKnownCaches();
  }
  public void cleanupKnownCaches() throws Exception {
  ...
  public void clear(  String className,  String fieldName){
    try {
  ...
  public void clear(  Class<?> type,  String fieldName) throws Exception {
 ...
 */
  public void forceReferenceCleanup(){
    try {
  ...
  /** 
 * Called to finish  {@link Restarter} initialization when application logging isavailable.
 */
  void finish(){
...
synchronized (this.monitor) {
  ...
  public void prepare(  GenericApplicationContext applicationContext){
    applicationContext.setResourceLoader(new ClassLoaderFilesResourcePatternResolver(this.classLoaderFiles));
  }
  public LeakSafeThread getLeakSafeThread(){
    try {
 ...
 */
  ...
  /** 
 * Initialize restart support. See {@link #initialize(String[],boolean,RestartInitializer)} for details.
 ...
 */
  ...
  /** 
 * Initialize restart support for the current application. Called automatically by {@link RestartApplicationListener} but can also be called directly if mainapplication arguments are not the same as those passed to the {@link SpringApplication}.
 * @param args main application arguments
 * @param forceReferenceCleanup if forcing of soft/weak reference should happen oneach restart. This will slow down restarts and is intended primarily for testing
 * @param initializer the restart initializer
 * @param restartOnInitialize if the restarter should be restarted immediately whenthe  {@link RestartInitializer} returns non {@code null} results
 */
...
synchronized (INSTANCE_MONITOR) {
  ...
  /** 
 * Return the active  {@link Restarter} instance. Cannot be called before{@link #initialize(String[]) initialization}.
 ...
 */
  public static void setInstance(  Restarter instance){
synchronized (INSTANCE_MONITOR) {
...
public class LeakSafeThread extends Thread {
    ...
    @SuppressWarnings("unchecked") public <V>V callAndWait(    Callable<V> callable){
      this.callable=callable;
      start();
      try {
        join();
 ...
 */
public class LeakSafeThreadFactory implements ThreadFactory {
