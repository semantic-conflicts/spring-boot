 ...
 */
  ...
  public File getManifestFile(  File root){
 ...
 */
public static class FileEntryIterator implements Iterator<Entry> {
    public Comparator<File> entryComparator=new EntryComparator();
    public File root;
    public boolean recursive;
    public Deque<Iterator<File>> stack=new LinkedList<Iterator<File>>();
    public File current;
    ...
    public Iterator<File> listFiles(    File file){
 ...
 */
public static class EntryComparator implements Comparator<File> {
